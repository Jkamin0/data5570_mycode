...
SECRET_KEY = 'django-insecure-zzrnmk$#%=lxqb@0()q@sa-rwof2_$=4ns^1xj292rff35aef^'
...
# CORS Configuration
# For development - allows local Expo app to connect
...
# Or specify exact production URLs:
# CORS_ALLOWED_ORIGINS = [
#     'https://your-expo-app-url.com',
#     'https://your-cloudflare-tunnel-url.com',
# ]
